...
sudo apt install -y kitty feh scrot scrub zsh rofi xclip bat locate ranger neofetch wmname acpi bspwm sxhkd imagemagick  cmatrix ranger kitty sxhkd imagemagick cmatrix
